...
?>>
  <?php if (isset($showLoader) && $showLoader): ?>
    <!-- 로딩 스피너 -->
    <div id="pageLoader" class="page_loader" <?php if (isset($loaderDuration))
      echo ' data-duration="' . $loaderDuration . '"'; ?><?php if (isset($loaderWaitForImages) && $loaderWaitForImages)
              echo ' data-wait-for-images="true"'; ?>>
      <div class="img_list">
        <img class="person" src="asset/images/spiner/img_01.gif" alt="loader_img_01" loading="eager" fetchpriority="high">
        <img class="chat_bubble" src="asset/images/spiner/chat_b_01.svg" alt="loader_chat_01" loading="eager"
          fetchpriority="high">
        <img class="person" src="asset/images/spiner/img_02.gif" alt="loader_img_02" loading="eager" fetchpriority="high">
        <img class="chat_bubble" src="asset/images/spiner/chat_b_02.svg" alt="loader_chat_02" loading="eager"
          fetchpriority="high">
        <img class="person" src="asset/images/spiner/img_03.gif" alt="loader_img_03" loading="eager" fetchpriority="high">
        <img class="chat_bubble" src="asset/images/spiner/chat_b_03.svg" alt="loader_chat_03" loading="eager"
          fetchpriority="high">
      </div>
